...
> [!IMPORTANT]
> To run this tool yourself, will need both direct access to the LiITA internal database and a link to the LiITA Stanza models. These will need to be configured either in the `docker-compose.yml` or in `apps/backend/.env`, depending on how you are running the tool. Simply put, this means you probably won't be able to run the tool on your machine unless you're in the LiITA team.
